...
The tutorial is meant to be simple and clear. So we intend to have only a few examples of requests and responses. A better example for different types of request/response would be inside the sdk codebase. It is located inside the sdk code repo, under actorx/examples. The Github link is \` [https://github.com/tearust/sdk/blob/master/actorx/examples/codec/src/lib.rs](https://github.com/tearust/sdk/blob/master/actorx/examples/codec/src/lib.rs).
