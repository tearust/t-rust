...
Usually there are two kinds of requests that need to be sent to the [State_Machine](State_Machine.md) to handle. They're either [queries](../../Sep2022_tokenomics/queries.md) or [commands](commands.md).
