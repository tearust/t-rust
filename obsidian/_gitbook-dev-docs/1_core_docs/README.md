...
- [[state|State]]: Usually used to store account balance. It runs inside the [state machine](../z_glossary/State_Machine.md).
- [[GlueSQL]]: Distributed SQL server instances. It's located inside the [state machine](../z_glossary/State_Machine.md).
